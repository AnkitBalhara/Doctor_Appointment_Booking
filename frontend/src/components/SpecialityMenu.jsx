    ...
    <div id="speciality" className="flex flex-col items-center gap-4 py-16 text-gray-800 ">
      ...
      <div className="flex sm:justify-center gap-4 pt-5 w-full overflow-hidden">
        {specialityData.map((item, index) => {
          return (
            <Link key={index} className="flex flex-col items-center text-xs cursor-pointer flex-shrink-0 hover:translate-y-[-10px] duration-500 " to={`/doctors/${item.speciality}`}>
